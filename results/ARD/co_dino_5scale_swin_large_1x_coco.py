...
data_root = '/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/annotations/train.json',
        img_prefix='/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/annotations/val.json',
        img_prefix='/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/annotations/test.json',
        img_prefix='/home/liuyuqing/liuyuqing/dataset/ARD-MAV/Coco-ARD/test/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
pretrained = 'models/swin_large_patch4_window12_384_22k.pth'
work_dir = '/home/liuyuqing/liuyuqing/code/Co-DETR/results/ARD'
auto_resume = False
gpu_ids = range(0, 4)
